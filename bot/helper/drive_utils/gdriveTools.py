...
class GoogleDriveHelper:
    ...
    def drive_list(self, fileName):
        ...
        for parent_id in DRIVE_ID :
            ...
            if response:
                if add_title_msg == True:
                    msg = f'<h3>Search Results for : {fileName}</h3><br><br><h4>🔐 To Get Access To Drive Links <a href="https://groups.google.com/g/gdrivemirrorcloud">👉Join Google Group</a></h4><br><br>'
                    add_title_msg = False
        ...
        for content in self.telegraph_content :
            self.path.append(telegra_ph.create_page(title = 'Gdrive Mirror Cloud',
